...
export class CCConfiguration {
  ...
  private m_annotationBackgroundColor: ConfigurationProperty<string> =
    new ConfigurationProperty('rgba(20, 20, 20, 0.8)');
  ...
  private m_checkoutCommand: ConfigurationProperty<string> =
    new ConfigurationProperty('-comment ${comment} ${filename}');
  private m_findCheckoutsCommand: ConfigurationProperty<string> = new ConfigurationProperty('-me -cview -short -avobs');
  private m_checkinCommand: ConfigurationProperty<string> =
    new ConfigurationProperty('-comment ${comment} ${filename}');
